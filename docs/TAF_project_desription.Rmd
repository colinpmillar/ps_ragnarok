...
*To implement a system that will give stock assessors the tools<br>
 to archive their data, methods and results, so that they can be<br>
 replicated at a future date and also be rerun the following year<br>
